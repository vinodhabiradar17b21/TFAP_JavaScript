		...
		var modelName  = '${modelName}';
            ...
            $(document).ready(function () {
                ...
                $('.table-filter-paymentterms-dropdown').on('change', function (e) {
                    ...
                    dataTable.column(6).search(accepted).draw();
                })
                ...
                $('.table-filter-initsettle-dropdown').on('change', function (e) {
                    ...
                    dataTable.column(11).search(initsettle).draw();
                })
                
             if(modelName === "tfImpBillSummary") {
               	 $('#search_8, #search_j8').daterangepicker({
	                   maxDate: new Date,
	                   //minDate: new Date,
	                   format: 'YYYY-MM-DD',
               	...
               	$('#search_9, #search_j9').daterangepicker({
	                   //maxDate: new Date,
	                   //minDate: new Date,
	                   format: 'YYYY-MM-DD',
	                   singleDatePicker: true,
              ...
              } else if(modelName === "tfImpSettlement") {
             	 $('#search_6, #search_7, #search_j6, #search_j7').daterangepicker({
	                   //maxDate: new Date,
	                   //minDate: new Date,
	                   format: 'YYYY-MM-DD',
	                   singleDatePicker: true,
                ...
                if(modelName === "tfImpBillSummary") {
                    ...
                    $('#search_9,#search_j9').on('change', function () {
	       			 ...
	       			 $('#search_6,#search_j6').on('change', function () {
	                        var submitted = $(this).val();
	                       	dataTable.column(6).search(submitted).draw();
	                    });
	                    $('#search_7,#search_j7').on('change', function () {
	                        var updated = $(this).val();
	                        dataTable.column(7).search(updated).draw();
	                    });
		       	}             
	       		else
	   			{
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="d-none">
                                    ...
                                    <tfap:tfapstatuslabel status="PCH"/>
                                    ...
                                    <tfap:tfapstatuslabel status="CAN"/>
                                    ...
                                    <tfap:tfapstatuslabel status="AMD"/>
                                    <tfap:tfapstatuslabel status="EXT"/>
                                    <tfap:tfapstatuslabel status="CNT"/>
                                </div>
                                ...
                                <script type="text/javascript">
                                    ...
                                    var productsActionDuplicate = ['LCISS', 'LCAMD', 'SCISS', 'SCAMD', 'BGISS', 'BGAMD', 'ECNEG', 'SGISS', 'SGAWB', 'SGBOL', 'SGLOI'];
                                    ...
                                    var stateUserRolesActionDuplicate = [
                                    	...
                                    	//{state: 'DRF', userRoles: ['TFAP_COM_MAKER']},
                                    	{state: 'PAU', userRoles: ['TFAP_COM_MAKER']},
                                    	{state: 'SUB', userRoles: ['TFAP_COM_MAKER']},
                                    	{state: 'PRO', userRoles: ['TFAP_COM_MAKER']}
                                    ];
                                        ...
                                        <c:forEach items="${columns}" var="column" varStatus="loop">
                                        {
                                            ...
                                            "mRender": function (data, type, full, row) {
	                                            	...
	                                            	*/
                                                    ...
                                                    if(modelName === "tfImpBillSummary" && (full.product == "IBLCN" || full.product == "IBULC"))
                                                   	...
                                                   	{   
                                               				...
                                               				if(productsActionSubmit.includes(product) && isPermitted(status, stateUserRolesActionImpBillsMaker))
                                                           	{
    	                                                       	//if settlement intiated block the settlement
                                                               	if(full.tibBillPmtTerms == 'DP') {
                                                                    if((full.tibBillSgRefNo != null && full.tibBillSgRefNo != '')) {
    	                                                        		items += actionItemSettleByDebit + actionItemSettleByImpLoan + actionItemSettleByOthers;                                                                        
                                                                    } else {
                                                                    	if(full.tibAccepted == 'YES') {
                                                                ...
                                                                } else if(full.tibBillPmtTerms == 'DA') {                                                            	
                                                                	if(full.tibAccepted == 'YES') {
           	                                                        	items += actionItemSettleByDebit + actionItemSettleByImpLoan + actionItemSettleByOthers;                                                                       	
                                                           			}                                                               
                                                                }	
                                                        ...
                                                        if (status == "DRF") {//draft
                                                            ...
                                                            if (productsActionConvert.includes(product) && isPermitted(status, stateUserRolesActionConvert) && full.isEnableConvertBtn) {
                                                ...
                                                /* else if(col == 'tibBillAmt'){ // for Import Bills List 
                                                	data =  full.tibBillAmt.split(' ')[0] == 'null' ? '' : full.tibBillAmt.split(' ')[0] +" "+ $.number(full.tibBillAmt.split(' ')[1], 2);
                                                } else if(col == 'tisBillSettleAmt'){ // for Import Settlement List 
                                                	data =  full.tisBillSettleAmt.split(' ')[0] == 'null' ? '' : full.tisBillSettleAmt.split(' ')[0] +" "+ $.number(full.tisBillSettleAmt.split(' ')[1], 2);
                                                }  */
...
<%--                                                     <c:when test="${ fn:contains(column, 'Product') || fn:contains(column, 'product')}">
                                                        ...
                                                        <th style="width:20px;">
                                                            <select class="form-control table-filter-status-dropdown">
                                                                ...
                                                                <c:forEach items="${filterStatus}" var="statusCode" varStatus="j">
								                                	<option value="${statusCode}"><spring:message code="label.tfApplication.${statusCode}"/></option>
								                                </c:forEach>
                                                            </select>
                                                        </th>
                                                        <% j++; %>
                                                    ...
                                                    <c:when test="${ fn:contains(column, 'Submitted') || fn:contains(column, 'submitted')}">
                                                        <c:choose>
                                                    	<c:when test="${modelName == 'tfImpSettlement'}">
                                                    		<th>
