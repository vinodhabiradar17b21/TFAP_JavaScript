    ...
    <div class="content-body">        
		...
		var modelName  = '${modelName}';
            ...
            $(document).ready(function () {
            	...
            	retriveFIlters('table-filter-paymentterms-dropdown');
                ...
                $('.table-filter-paymentterms-dropdown').on('change', function (e) {
                    ...
                    window.sessionStorage.setItem('table-filter-paymentterms-dropdown', accepted);
                ...
                if(modelName === "tfImpBillSummary" || modelName === "tfImpSettlement") {
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="d-none">
                                    ...
                                    <tfap:tfapstatuslabel status="IRJ"/>
                                    <tfap:tfapstatuslabel status="IAP"/>
                                ...
                                <script type="text/javascript">
                                    ...
                                    var stateUserRolesActionRecieved = [
                                        {state: 'SUB', userRoles: ['TFAP_BANK_ADMIN', 'TFAP_BANK_USER']}
                                    ];
                                    var stateUserRolesActionProccessing = [
                                        {state: 'RCV', userRoles: ['TFAP_BANK_ADMIN', 'TFAP_BANK_USER']}
                                    ];
